...
export default function Footer() {
  return (
    <footer className='flex bg-primary relative z-10 w-full justify-center pt-[80px] border-2 border-t-secondary border-primary'>
  ...
  <defs>
    <linearGradient id="paint0_linear_570_3523" x1="678" y1="-393" x2="678" y2="914" gradientUnits="userSpaceOnUse">
      ...
      <div className="max-w-[1100px] flex flex-col justify-center items-center">
        ...
        <small className='text-center text-xs py-5'>2023 Grupo Gester by Chimpancé Digital • Todos los derechos reservados</small>
      </div>
    </footer>
  )
}
