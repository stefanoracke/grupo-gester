...
export default function Navbar({ navActive }) {
    ...
    return (
        ...
        <nav className='w-full py-4 lg:py-6 px-[6vw] flex justify-between fixed top-0 bg-primary z-40'>
            <div className=' z-20'>
                <a href="#heroS1">
            ...
            <div className='flex items-center relative'>
                <div onClick={handleClick} className="absolute right-6 top-2 lg:hidden z-20">
                ...
                <ul className='p-0 list-style-none  gap-8 items-end hidden lg:flex'>
                    <li>
                        <a
