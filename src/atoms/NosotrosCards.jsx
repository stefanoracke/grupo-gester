...
export default function NosotrosCards({ persona }) {

  return (
    <div  className='w-[300px] nosotros-card h-[450px] relative rounded-[15px] overflow-hidden bg-nosotros1 relative'>
      <div className='flex  p-[35px] h-full w-full'>
      <div className='bg-nosotros1 w-full h-full absolute left-0 top-0 z-10'></div>
        <img src={persona.img} alt="" className='absolute w-full h-full object-cover top-0 left-0' />
